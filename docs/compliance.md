...
Reviewed on **2026-08-28 (JST)** for a private, personal research deployment. The operator's rule is to crawl only when no explicit applicable prohibition is found. `robots.txt`, published terms, authentication boundaries, and rate limits remain mandatory. Re-check before every enablement.
